...
{
    public class GetPortfolioByCustomerQueryHandler : IRequestHandler<GetPortfolioByCustomerQuery, PortfolioDB>
    {
        ...
        public async Task<PortfolioDB> Handle(GetPortfolioByCustomerQuery command, CancellationToken cancellationToken)
        {
            try
            {
