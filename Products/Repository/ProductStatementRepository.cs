...
namespace Products.Repository
{
    ...
    : IProductStatementRepository
    {
        ...
        public async Task<List<ProductDB>> GetStatementBy(string? name, ulong? userId, DateTime? expirationDate,Guid? productId, CancellationToken cancellationToken)
        {
